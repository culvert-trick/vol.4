...
でも、単純作業の日々に、言われたことをこなす日々に、「楽しくない」「もう飽きた」と感じているあなたには、新たな一歩を踏み出してほしい。
あなたがすでに一歩も二歩も踏み出していたとしても、更なる一歩や、周りの踏み出しきれていない人をサポートするための一手として、ここからのお話を一緒に辿ってみてほしい。
...
//footnote[fn01][筆者は【テスト設計コンテスト'17 OPENクラス】に出場経験あり。テスコンの詳細はこちら→http://aster.or.jp/business/contest.html]
2018年のOPENクラスのチュートリアル@<fn>{fn02}で、みんな大好きにしさんが『テストエンジニアのマインドを、表を埋める単純作業からクリエイティブなモデリングに変えていく』ということを話した。
『考えろ、考えろ、考えろ』というメッセージに、「私は何ができるのか？」という問いを突き付けられた気持ちだった。
//footnote[fn02][OPENクラスのチュートリアルの資料はこちら→http://aster.or.jp/business/contest/tutorial.html]

当時も今も、テストの世界に関わりつつも、ストレートにテストエンジニアをやっている訳ではない立場で。
私を外の世界に連れ出してくれたきっかけであるテストの領域で、私なりに貢献できることはないか。
実行委員をやっている【WACATE】@<fn>{fn03}で、転身を促すワークショップを開発して実施してみた。
そして、そのワークショップ事例を【SQiPシンポジウム2019】@<fn>{fn04}で発表した。
そんな流れを文章に書き起こしたのが、今回のお話しである。
//footnote[fn03][WACATEは1泊2日合宿形式のワークショップのコミュニティ。年2回開催で次は2020夏5/30-31。詳細はこちら→https://wacate.jp/]
//footnote[fn04][正式名称はソフトウェア品質シンポジウム。発表した回はこちら→https://www.juse.jp/sqip/symposium/2019/]

WACATEでのワークショップ公開資料@<fn>{fn05}やSQiPシンポジウムでの事例発表の公開資料@<fn>{fn06}とも、あわせ読んでもらえると、更に理解が深まるかもしれない。
//footnote[fn05][WACATE2018冬で実施【コマンド＆コントロールから抜け出そう！？】資料はこちら→https://speakerdeck.com/caori_t/escape-cc]
//footnote[fn06][SQiPシンポジウム2019で経験発表。C3-3【自律的に思考するテストエンジニアへの転身を促進するソフトスキル系ワークショップの開発と実行】資料はこちら→https://www.juse.jp/sqip/symposium/2019/timetable/files/C3-3_happyou.pdf]
...
ご意見ご感想はTwitterで@caori_tにメンションしてもらえたらいいなぁ。
